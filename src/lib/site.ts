...
export const CONTACT_EMAIL = 'info@terrorplay.com';
...
/** Perfiles sociales (se usan en el footer y en los datos estructurados). */
export const INSTAGRAM_URL = 'https://www.instagram.com/terrorplayeventos/';
