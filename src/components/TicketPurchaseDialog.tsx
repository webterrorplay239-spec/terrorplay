  ...
  return (
    <Dialog open={isOpen} onOpenChange={resetAndClose}>
      <DialogContent className="max-w-md bg-card text-card-foreground border-accent shadow-2xl shadow-accent/20">
        <DialogHeader>
          <DialogTitle className="font-['Lacquer',_cursive] text-3xl text-primary text-center">Compra tus Entradas</DialogTitle>
        ...
        {step === 1 && (
          <div className="space-y-6 py-4">
            ...
            <div className="space-y-2">
              <Label className="font-['Lacquer',_cursive] text-lg">Tipo de Entrada</Label>
                ...
                {Object.entries(ticketTypes).map(([key, { name, price }]) => (
                  <div key={key} className="flex items-center justify-between">
                    <Label htmlFor={key} className="flex items-center space-x-3 cursor-pointer">
                      ...
                      <span className="font-['Alegreya',_serif] text-base">{name}</span>
                    </Label>
            ...
            {/* Quantity */}
            <div className="space-y-2">
              <Label className="font-['Lacquer',_cursive] text-lg">Cantidad</Label>
            ...
            {/* Date */}
            <div className="space-y-2">
              <Label className="font-['Lacquer',_cursive] text-lg">Fecha</Label>
               <Popover>
        ...
        {step === 2 && (
          <div className="space-y-4 py-4">
            <h3 className="font-['Lacquer',_cursive] text-xl text-center text-primary">Resumen del Pedido</h3>
            <div className="p-4 rounded-lg border bg-background/50 space-y-2">
                ...
                <p className="font-['Lacquer',_cursive] text-2xl text-right"><strong>Total: <span className="text-accent">{total}€</span></strong></p>
            </div>
             <h3 className="font-['Lacquer',_cursive] text-xl text-center text-primary pt-4">Selecciona un método de pago</h3>
        ...
        {step === 3 && (
            <div className="text-center py-8 space-y-4">
                <h3 className="font-['Lacquer',_cursive] text-2xl text-accent">¡Pago completado!</h3>
