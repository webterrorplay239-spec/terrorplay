...
const contactSchema = z.object({
  ...
  eventType: z.enum(['pasaje-terror', 'escape-room', 'cena-misterio', 'real-game', 'otro'], { required_error: "Selecciona un tipo de evento." }),
  ...
  // Campo trampa antispam: oculto para las personas, tentador para los bots.
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 space-y-12">
       <section className="text-center animate-fade-in relative overflow-hidden rounded-lg p-4">
        ...
        <h1 className="text-5xl md:text-7xl font-horror text-primary mb-4 animate-text-flicker">Contacta con Nosotros</h1>
      ...
      <Card className="shadow-2xl shadow-primary/20 animate-slide-up max-w-2xl mx-auto bg-scratches">
        <CardHeader>
          <CardTitle className="font-horror text-2xl">Solicita tu Presupuesto</CardTitle>
        ...
        <CardContent>
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                      ...
                      <FormItem>
                        ...
                        <Select onValueChange={field.onChange} defaultValue={field.value}>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="real-game">Real Game / Supervivencia Zombie</SelectItem>
                ...
                />
                {/* Campo trampa antispam: invisible y fuera del orden de tabulación */}
